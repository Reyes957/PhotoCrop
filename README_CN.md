...
最开始我打算用 AI 来做这件事——把扫描好的 PDF 扛进去，让模型自己把每张照片找出来裁好。但现实比数据集粗糙多了。有些老胶片直接粘在相册纸上，撕不下来，扫描出来带着纸屑和相册的边角。有些照片在相册边缘放了太久，边缘已经被腐蚀，图像糊成一片。还有些胶片本身就过曝了，人脸白成一团印在白色 PDF 上，连人眼都要凑近才能分辨照片和背景的边界在哪里。AI 搞不定这些。
